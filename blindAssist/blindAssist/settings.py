"""
Django settings for blindAssist project.
...
STATIC_ROOT = os.path.join(BASE_DIR, 'blindapp/staticfiles' )
MEDIA_URLS ='/media/'
...
# ALLOWED_HOSTS = ['your-pythonanywhere-domain.pythonanywhere.com', 'localhost', '127.0.0.1']